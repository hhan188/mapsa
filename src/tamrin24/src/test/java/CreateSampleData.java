...
public class CreateSampleData {
    ...
    public static void main(String[] args) {
        ...
        Author a6 = new Author("Ehsan", LocalDate.of(1998, 8, 8));
        authorBS.save(a6);
        ...
        //Create Posts --------------------------------------------------------
        PostService postBS = new PostService();
        ...
        postBS.save(p9);
        Post p10 = new Post("My Java, Hibernate, Spring & Spring Boot content", a3);
        postBS.save(p10);
        postBS.addCategoryToPost(p10,Set.of(c2,c4,c5,c6));
